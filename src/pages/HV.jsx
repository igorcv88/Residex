...
const S = {
  ...
  tab: (active) => ({
    ...
    padding: "0.55rem",
    borderRadius: 8,
    border: active ? "1px solid rgba(125,211,252,0.4)" : "1px solid rgba(255,255,255,0.07)",
...
>
  ← MedPanel
        ...
        <div style={S.header}>
          ...
          <p style={S.headerSub}>Holliday-Segar · AHV Ataque · Soro de Manutenção</p>
        </div>
        ...
        <div style={S.body}>
              ...
              {isValid && volTotal ? (
                <>
                  ...
                  <div style={S.resultBlock}>
                    <p style={S.resultTitle}>Volume Total / 24 h — Holliday-Segar</p>
                    <div style={S.resultGrid}>
                      ...
                      <div style={S.resultItem}>
                        ...
                        <span style={{ fontSize: "0.72rem", color: "#7dd3fc", lineHeight: 1.4 }}>
                          {pesoClass}
                        </span>
                      </div>
                    </div>
            ...
            <>
              <div style={S.section}>
                ...
                <div style={S.inputGroup}>
                  ...
                  />
                  <span style={{ fontSize: "0.62rem", color: "#475569", marginTop: 4 }}>
              ...
              {isValid && volAtaque ? (
                <div style={S.resultBlock}>
                  ...
                  <div style={{ marginTop: "1.25rem" }}>
                    <p style={{ ...S.sectionLabel, marginBottom: "0.6rem" }}>Velocidade de infusão</p>
                    <div style={S.compRow}>
          ...
          <p style={{
            ...
            HOLLIDAY & SEGAR, 1957 · NaCl 20%: 3,4 mEq Na⁺/mL · KCl 10%: 1,34 mEq K⁺/mL · KCl 19,1%: 2,57 mEq K⁺/mL
            <br />
            Uso exclusivo para profissionais de saúde. Confirme sempre os cálculos clinicamente.
          </p>
        </div>
      </div>
    </div>
