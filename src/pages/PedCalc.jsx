...
export default function PedCalc() {
  ...
  const catColor =
    DRUG_CATEGORIES.find((c) => c.id === (selDrug?.category || "todos"))
      ?.color || "#64748b";
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                border: `1px solid ${tab === t ? c + "44" : T.borderCard}`,
                color: tab === t ? c : "#4b5563",
                padding: "7px 18px",
                borderRadius: 5,
                cursor: "pointer",
                fontFamily: "monospace",
            ...
            {!selDrug ? (
              ...
              <>
                ...
                >
                  ...
                  >
                    {
                      DRUG_CATEGORIES.find((c) => c.id === selDrug.category)
                        ?.name
                    }
                  </div>
        ...
        <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "22px 24px" }}>
            {!selEm ? (
              ...
              >
                ← Selecione um protocolo de emergência
              </div>
            ) : (
              <>
                {/* cabeçalho */}
