  ...
  introducao: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { label: "Prevalência Brasil", value: "Aumento de 72% nos últimos 15 anos. Classes sociais mais baixas desproporcionalmente afetadas.", highlight: true },
          { label: "Sedentarismo", value: "Principal fator ambiental modificável. Urbanização e tecnologia reduzem gasto energético basal.", highlight: false },
          { label: "Consumo de ultraprocessados", value: "Ambiente obesogênico: alimentos baratos, palatáveis, calóricos e de fácil acesso.", highlight: true },
          { label: "Histórico familiar (HF)", value: "Herança poligênica em 40–70%. Risco aumenta 2–3× com parente de 1º grau com obesidade.", highlight: false },
          { label: "Sexo feminino", value: "Maior prevalência de obesidade grau III. Efeitos hormonais (estrogênio → adipogênese).", highlight: false },
        ],
      },
      {
        type: "grid",
        ...
        items: [
          { label: "DM2", value: "IMC > 35 associa risco >50× para DM2. Resistência insulínica como elo central.", highlight: true },
          { label: "Dislipidemia (DLP)", value: "TG↑ + HDL↓ + LDL pequenas e densas = dislipidemia aterogênica.", highlight: false },
          { label: "Mortalidade cardiovascular", value: "HAS, DAC, ICC, AVC, fibrilação atrial. Risco aumenta progressivamente com o IMC.", highlight: true },
          { label: "Câncer", value: "Mama, endométrio, próstata, TGI, renal, melanoma múltiplo, LMA. Mecanismo: hiperinsulinismo + inflamação crônica + hiperestrogenismo.", highlight: true },
          { label: "Apneia obstrutiva do sono (SAOS)", value: "Obesidade = principal fator de risco para SAOS. Gordura cervical estreita as vias aéreas superiores.", highlight: false },
          { label: "HAS/DCEM/DENC", value: "Hiperatividade simpática + SRAA + hiperleptinemia. Resistência à leptina perpetua HAS.", highlight: false },
          { label: "Doenças psiquiátricas", value: "Depressão, ansiedade, compulsão alimentar — causa E consequência da obesidade.", highlight: false },
          { label: "DHEM / Esteatose hepática", value: "Presente em ~80% dos obesos. Risco de progressão para MASH, cirrose e CHC.", highlight: false },
        ],
      },
      {
        type: "obs",
  ...
  fisiopatologia: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { label: "Poligênica (mais prevalente)", value: "Centenas de variantes comuns (GWAS). Gene FTO mais estudado. Predisposição amplificada pelo ambiente. Sem hiperfagia grave ou síndrome associada.", highlight: true },
          { label: "Monogênica (rara, grave)", value: "Mutações em LEP, LEPR, MC4R (mais comum — 5–6% das obesidades graves infantis), POMC, PCSK1. Início PRECOCE + hiperfagia INTENSA + resistente ao tratamento convencional.", highlight: true },
          { label: "Quando suspeitar de monogênica?", value: "Obesidade grave de início precoce (infância) + hiperfagia intensa + síndrome clínica associada + refratária ao manejo padrão → indicação de teste genético.", highlight: true },
          { label: "Tratamento específico — Setmelanotida", value: "Agonista do receptor MC4R. Indicado em obesidade monogênica por deficiência de leptina/receptor ou mutações POMC/MC4R. TTO direcionado pelo diagnóstico genético.", highlight: false },
          { label: "Gene MC4R", value: "Receptor de melanocortina 4 — via leptina-melanocortina hipotalâmica. Mutação = causa mais comum de obesidade monogênica.", highlight: false },
          { label: "Síndromes genéticas clássicas", value: "Prader-Willi (hiperfagia + hipotonia + baixa estatura), Bardet-Biedl (retinite pigmentosa + polidactilia + DRC), Alström (cegueira + surdez + DM2).", highlight: false },
        ],
      },
      {
        type: "obs",
        ...
        grades: [
          {
            grade: "SP",
            color: "#F59E0B",
            items: ["Sobrepeso", "IMC 25–29,9 kg/m²", "Farmacoterapia: IMC ≥ 27 + comorbidade"],
          },
          {
            grade: "I",
            color: "#F97316",
            items: ["Obesidade Grau I", "IMC 30–34,9 kg/m²", "Farmacoterapia indicada (sem comorbidade)"],
          },
          {
            grade: "II",
            color: "#EF4444",
            items: ["Obesidade Grau II", "IMC 35–39,9 kg/m²", "Cirurgia bariátrica: ≥ 35 + comorbidade"],
          },
          {
            grade: "III",
            color: "#8B5CF6",
            items: ["Obesidade Grau III", "IMC ≥ 40 kg/m²", "Cirurgia bariátrica: ≥ 40 sem comorbidade"],
          },
        ],
      },
      {
        ...
        items: [
          { label: "Circunferência Abdominal (CA)", value: "Risco aumentado: H ≥ 94 cm / M ≥ 80 cm. Risco muito aumentado: H ≥ 102 cm / M ≥ 88 cm. Critério síndrome metabólica.", highlight: true },
          { label: "Relação Cintura-Quadril (RCQ)", value: "H > 0,90 / M > 0,85 = risco cardiovascular aumentado. Melhor que CA isolada em alguns grupos.", highlight: false },
          { label: "Circunferência Cervical", value: "H ≥ 39 cm / M ≥ 35 cm = risco cardiometabólico aumentado. Correlaciona com gordura visceral e SAOS.", highlight: false },
          { label: "Circunferência da Panturrilha", value: "< 31 cm = massa muscular reduzida → risco de obesidade SARCOPÊNICA. Idosos e pacientes em uso de análogos GLP-1.", highlight: true },
          { label: "Obesidade sarcopênica", value: "IMC aumentado + panturrilha < 31 cm + força reduzida. Atenção especial com análogos GLP-1 (reduzem massa magra também).", highlight: true },
          { label: "BIA / DEXA", value: "Bioimpedância (BIA): rápida, acessível; influenciada pela hidratação. DEXA: padrão para composição corporal em pesquisa.", highlight: false },
        ],
      },
      {
        type: "flow",
        ...
        steps: [
          { text: "Glicemia em jejum + HbA1c — rastreio DM mesmo < 35 anos se sobrepeso/obesidade", color: "#F59E0B" },
          { text: "Perfil lipídico — TG, CT, LDL, HDL. Dislipidemia aterogênica (TG↑ + HDL↓) em 60–70%", color: "#EF4444" },
          { text: "TGO/TGP/GGT + FIB-4 — rastreio DHEM. FIB-4 > 1,3 + síndrome metabólica = elastografia", color: "#F97316" },
          { text: "TSH — excluir hipotireoidismo como causa de ganho de peso", color: "#10B981" },
          { text: "Cortisol urinário/salivar — se suspeita de Cushing (adiposidade central + HAS + estrias)", color: "#8B5CF6" },
          { text: "Creatinina + microalbuminúria — nefropatia hipertensiva/diabética precoce", color: "#6366F1" },
        ],
      },
      {
        type: "obs",
  ...
  sindrome: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { label: "1. Circunferência Abdominal", value: "H ≥ 102 cm / M ≥ 88 cm. Critério obrigatório pela IDF (central para diagnóstico).", highlight: true },
          { label: "2. Glicemia em jejum", value: "≥ 100 mg/dL OU em tratamento para hiperglicemia (metformina, insulina, etc).", highlight: true },
          { label: "3. Pressão Arterial", value: "≥ 130/85 mmHg OU em uso de anti-hipertensivo.", highlight: true },
          { label: "4. HDL reduzido", value: "H < 40 mg/dL / M < 50 mg/dL OU em TTO para dislipidemia.", highlight: true },
          { label: "5. Triglicerídeos elevados", value: "≥ 150 mg/dL OU em TTO específico.", highlight: true },
        ],
      },
      {
        type: "grid",
        ...
        items: [
          { label: "Doença aterosclerótica", value: "IAM, AVC. Risco CV aumentado 2–3× em relação à população geral.", highlight: true },
          { label: "DM2", value: "Progressão de pré-diabetes para DM2 acelerada. Resistência insulínica crescente.", highlight: true },
          { label: "Esteatose hepática (DHEM/MASH)", value: "FIB-4 obrigatório quando síndrome metabólica + transaminases alteradas.", highlight: false },
          { label: "Doença renal crônica", value: "Nefropatia hipertensiva e/ou diabética. Hiperfiltração glomerular inicial.", highlight: false },
        ],
      },
      {
        type: "flow",
        ...
        steps: [
          { text: "Mudança de estilo de vida: redução de 10–15% do peso corporal + abandono do tabagismo", color: "#10B981" },
          { text: "Atividade física ≥ 150 min/sem aeróbica + resistência (melhora sensibilidade à insulina)", color: "#10B981" },
          { text: "Dieta: redução de gordura saturada e trans + aumento de fibras, frutas e vegetais", color: "#F59E0B" },
          { text: "Farmacológico: GLP-1 (perda de peso) + Metformina (resistência insulínica) + IECA/BRA (PA) + estatina (risco CV) + fibrato (TG > 500)", color: "#0EA5E9" },
        ],
      },
      {
        type: "obs",
  ...
  mev: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { label: "Mínimo para saúde geral", value: "≥ 150 min/semana de aeróbico de intensidade moderada.", highlight: false },
          { label: "Para perda de peso", value: "≥ 300 min/semana de aeróbico + exercício de resistência 2×/semana.", highlight: true },
          { label: "Resistência (musculação)", value: "Preserva massa magra durante a perda de peso. Fundamental com análogos de GLP-1 (reduzem massa magra).", highlight: true },
          { label: "Limitações", value: "Considerar restrições ortopédicas e cardiovasculares. Iniciar com baixa intensidade e progredir.", highlight: false },
        ],
      },
      {
        type: "grid",
        ...
        items: [
          { label: "Déficit calórico", value: "500–1.000 kcal/dia abaixo do gasto energético total. Não indicado déficit restritivo extremo (< 800 kcal/dia) sem supervisão.", highlight: true },
          { label: "Tipo de dieta", value: "Sem diferença significativa entre dietas para perda de peso. Mediterrânea e low carb têm benefício na mortalidade CV e controle glicêmico.", highlight: false },
          { label: "Proteínas adequadas", value: "≥ 1,2–1,5 g/kg/dia durante perda de peso com análogos GLP-1 para minimizar perda de massa magra.", highlight: true },
          { label: "Ultraprocessados", value: "Redução é mais importante que o tipo de dieta. Alto volume calórico, baixa saciedade, grande palatabilidade.", highlight: false },
        ],
      },
      {
        type: "grid",
        ...
        items: [
          { label: "2,5% de perda", value: "Redução de glicemia, triglicerídeos e melhora da fertilidade.", highlight: false },
          { label: "5–10% de perda", value: "Aumento de HDL, controle de dor articular, melhora de depressão, qualidade de vida e função sexual.", highlight: true },
          { label: "10–16% de perda", value: "Melhora de esteato-hepatite (MASH) e redução de eventos cardiovasculares.", highlight: true },
          { label: "> 16% de perda", value: "Redução de mortalidade por todas as causas.", highlight: true },
          { label: "Meta ideal de tratamento", value: "≥ 10% de perda com pelo menos 5% nos primeiros 3 meses.", highlight: true },
        ],
      },
      {
        type: "obs",
  ...
  comparativo: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { label: "Sibutramina", value: "Mec: ISRNS | Perda: 5–8% | CI: Alto risco CV | EA: ↑PA, ↑FC | Custo: baixo", highlight: false },
          { label: "Orlistate", value: "Mec: Inibidor lipase | Perda: 3–5% | CI: colestase | EA: esteatorreia | Custo: baixo", highlight: false },
          { label: "Liraglutida", value: "Mec: aGLP-1 SC diário | Perda: 5–8% | CI: CMT/MEN-2 | EA: TGI | Custo: alto", highlight: false },
          { label: "Semaglutida", value: "Mec: aGLP-1 SC semanal | Perda: 10–15% | CI: CMT/MEN-2 | EA: TGI | CV: SELECT 2023 | Custo: muito alto", highlight: true },
          { label: "Tirzepatida", value: "Mec: dual GIP+GLP-1 SC semanal | Perda: 15–22% | EA: TGI | Superior à sema 2025 | Custo: muito alto", highlight: true },
          { label: "BUP+Naltrexona", value: "Mec: ISND + anti-opioide | Perda: 5–9% | CI: epilepsia, opioides | Indicado: compulsão alimentar", highlight: false },
          { label: "Topiramato", value: "Mec: GABA/Glu modulation | Perda: 5–10% | CI: gravidez, nefrolitíase | Indicado: compulsão + insônia | Off-label", highlight: false },
          { label: "Setmelanotida", value: "Mec: agonista MC4R | Indicado: obesidade monogênica genética | Raríssimo", highlight: false },
        ],
      },
      {
        type: "decision",
            ...
            {block.grades.map((g, i) => (
              <div key={i} style={{ background: `${g.color}0a`, border: `1px solid ${g.color}30`, borderRadius: 6, overflow: "hidden" }}>
                <div style={{ background: `${g.color}20`, padding: "8px 12px", borderBottom: `1px solid ${g.color}30`, display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{ width: 30, height: 30, borderRadius: "50%", background: g.color, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "#fff", fontWeight: 700, fontFamily: "monospace", flexShrink: 0 }}>{g.grade}</div>
  ...
  return (
    <div style={{ background: "#06080f", minHeight: "100vh", fontFamily: "'Palatino Linotype', 'Book Antiqua', Palatino, serif", color: "#dde3f0", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ borderBottom: "1px solid #111827", padding: "16px 28px", background: "#080b14" }}>
        ...
        <h1 style={{ margin: 0, fontSize: 20, fontWeight: 400, color: "#f1f5f9", letterSpacing: "0.01em" }}>Obesidade — Guia Completo</h1>
        <div style={{ fontSize: 11, color: "#374151", marginTop: 4, fontFamily: "monospace" }}>Introdução · Fisiopatologia · Avaliação · Sd. Metabólica · MEV · Farmacologia · Comparativo</div>
      </div>
