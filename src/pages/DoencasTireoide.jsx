...
const content = {
  anatomia: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          {
            label: "Células Foliculares",
            value:
              "Produzem T3 e T4. Organizam-se em folículos preenchidos por coloide (tireoglobulina). Transportam iodeto via NIS (cotransportador Na/I).",
            highlight: true,
          },
          {
            label: "Células Parafoliculares (C)",
            value:
              "Produzem CALCITONINA (↓ cálcio sérico). Origem na crista neural. Base para o carcinoma medular.",
            highlight: true,
          },
          {
            label: "Coloide",
            value:
              "Proteína tireoglobulina iodada. Reservatório de hormônio pré-formado. Aparece como material rosado na histologia.",
            highlight: false,
          },
          {
            label: "Nervo laríngeo recorrente",
            value:
              "Passa posterior à tireoide → movimentos das pregas vocais. Lesão cirúrgica → disfonia / rouquidão.",
            highlight: true,
          },
        ],
      },
      ...
      },
      {
        ...
        steps: [
          {
            text: "Hipotálamo → TRH → estimula TSH na hipófise anterior",
            color: "#F97316",
          },
          {
            text: "TSH → estimula TODAS as etapas da síntese e liberação de T3/T4",
            color: "#F59E0B",
          },
          {
            text: "T3/T4 livres → feedback NEGATIVO sobre TRH e TSH",
            color: "#10B981",
          },
          {
            text: "Efeito Wolff-Chaikoff: EXCESSO de iodo → inibição paradoxal da síntese (autoproteção)",
            color: "#0EA5E9",
          },
          {
            text: "Efeito Jod-Basedow: EXCESSO de iodo em tireoide patológica → hipertireoidismo",
            color: "#EF4444",
          },
        ],
      },
  ...
  laboratorio: {
    title:
      "Laboratório — Interpretação de TSH, T4L, Anticorpos e Cintilografia",
    blocks: [
      {
        type: "alert",
        color: "#F59E0B",
        ...
        grades: [
          {
            ...
            items: [
              ...
              "TSH ↓↓ (<0,1)",
              "T4L ↑ e/ou T3 ↑",
              "Causa: Graves, BNT, adenoma tóxico",
            ],
          },
          {
            grade: "↓T",
            ...
            items: [
              ...
              "TSH ↑↑ (>10)",
              "T4L ↓",
              "Causa: Hashimoto, pós-tireoidectomia",
            ],
          },
          {
            grade: "SC+",
            ...
            items: [
              "Hiper subclínico",
              "TSH 0,1–0,4 (supresso)",
              "T4L e T3 normais",
              "Risco: FA, osteoporose",
            ],
          },
          {
            grade: "SC-",
      ...
      },
      {
        ...
        items: [
          {
            label: "Anti-TPO (antitireoperoxidase)",
            value:
              "Presente em 80–99% da Tireoidite de Hashimoto. Também em Graves (até 90%). Valor prognóstico: anti-TPO + → maior risco de progressão para hipotireoidismo.",
            highlight: true,
          },
          {
            label: "Anti-Tg (antitireoglobulina)",
            value:
              "Positivo em ~60% da Tireoidite de Hashimoto. Menos específico que anti-TPO. Interfere na dosagem de Tg no seguimento do câncer.",
            highlight: false,
          },
          {
            label: "TRAb (anti-receptor de TSH)",
            value:
              "Diagnóstico de Doença de Graves (sensibilidade 97%). Inclui anticorpos estimuladores (TSI) e bloqueadores. Atravessa placenta → hipertireoidismo fetal.",
            highlight: true,
          },
          {
            label: "Calcitonina",
            value:
              "Marcador do carcinoma MEDULAR. Elevada na suspeita. Seguimento pós-cirúrgico junto ao CEA.",
            highlight: true,
          },
          {
            label: "Tireoglobulina (Tg)",
            value:
              "Marcador de seguimento no câncer DIFERENCIADO (papilífero/folicular) após tireoidectomia. Interferência se anti-Tg positivo.",
            highlight: true,
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "RAIU elevada (35–95%)",
            value:
              "Hipertireoidismo real: Doença de Graves (capta difuso), adenoma tóxico (quente), bócio multinodular tóxico.",
            highlight: true,
          },
          {
            label: "RAIU baixa (< 5%)",
            value:
              "Tireotoxicose SEM hiperfunção: Tireoidite destrutiva (liberação de hormônio pré-formado), tireotoxicose factícia.",
            highlight: true,
          },
          {
            label: "Nódulo quente",
            value:
              "Hipercaptante → funcionante → raramente maligno (< 1%). Pesquisar se TSH suprimido.",
            highlight: false,
          },
          {
            label: "Nódulo frio",
            value: "Hipocaptante → risco de malignidade 10–15% → indicar PAAF.",
            highlight: false,
          },
        ],
      },
  ...
  hipertireoidismo: {
    ...
    blocks: [
        ...
        items: [
          {
            label: "Adrenérgicas",
            value:
              "Taquicardia, palpitações, tremor fino, sudorese, intolerância ao calor, hipertensão sistólica, FA (risco em idosos).",
            highlight: true,
          },
          {
            label: "Metabólicas",
            value:
              "Perda de peso apesar de polifagia, diarreia, hiperglicemia (↑glicogenólise por catecolaminas), ↓LDL.",
            highlight: false,
          },
          {
            label: "Neuropsiquiátricas",
            value:
              "Ansiedade, irritabilidade, insônia, labilidade emocional, fraqueza muscular proximal.",
            highlight: false,
          },
          {
            label: "Dermatológicas",
            value:
              "Pele quente e úmida, queda de cabelo, mixedema pré-tibial (Graves), acropaquia (Graves).",
            highlight: false,
          },
          {
            label: "Sinal de Lid-Lag",
            value:
              "Retardo do movimento palpebral superior → exposição da esclera ao olhar para baixo. Qualquer tireotoxicose.",
            highlight: true,
          },
          {
            label: "Oftalmopatia de Graves",
            value:
              "EXCLUSIVA da Doença de Graves (exoftalmia, proptose, diplopia, quemose). Pode surgir mesmo após cura.",
            highlight: true,
          },
        ],
      },
      ...
      },
      {
        ...
        steps: [
          {
            text: "Beta-bloqueador (propranolol 40–80 mg/dia) → controle imediato dos sintomas adrenérgicos",
            color: "#F59E0B",
          },
          {
            text: "Metimazol — 1ª linha (dose conforme T4L). Início de ação: 1–2 semanas",
            color: "#EF4444",
          },
          {
            text: "Monitorar: TGO/TGP (hepatotoxicidade) e leucograma (agranulocitose — suspender se febre/faringite)",
            color: "#F97316",
          },
          {
            text: "Duração: 18 meses → tentar suspensão → verificar TRAb para prognóstico de recidiva",
            color: "#F59E0B",
          },
          {
            text: "50% de recidiva → opção definitiva: iodo radioativo (RAI) ou tireoidectomia total",
            color: "#6366F1",
          },
          {
            text: "Oftalmopatia grave: glicocorticoide IV antes do RAI (RAI agrava oftalmopatia — especialmente em tabagistas)",
            color: "#EC4899",
          },
        ],
      },
  ...
  crise: {
    ...
    blocks: [
        ...
        items: [
          {
            label: "Hipertermia",
            value:
              "Febre > 38–39°C (às vezes > 40°C). Sinal cardinal. NÃO usar salicilatos (↑ T4 livre por deslocamento da TBG).",
            highlight: true,
          },
          {
            label: "Taquicardia > 130 bpm",
            value:
              "FA de alta resposta, ICC de alto débito, choque cardiogênico.",
            highlight: true,
          },
          {
            label: "Alteração neurológica",
            value: "Agitação, delirium, psicose, convulsões, até coma.",
            highlight: true,
          },
          {
            label: "Manifestações GI",
            value:
              "Náuseas, vômitos, diarreia, dor abdominal, icterícia (disfunção hepática grave).",
            highlight: false,
          },
          {
            label: "Fatores precipitantes",
            value:
              "Infecção (mais comum), cirurgia, trauma, parto, AVC, IAM, suspensão abrupta de antitireoidiano, contraste iodado.",
            highlight: true,
          },
        ],
      },
      {
        ...
        steps: [
          {
            text: "1. BETA-BLOQUEADOR: Propranolol 60–80 mg a cada 4–6h VO ou esmolol IV. Bloqueia sintomas adrenérgicos + inibe conversão periférica T4 → T3",
            color: "#EC4899",
          },
          {
            text: "2. ANTITIREOIDIANO: PTU 200–400 mg a cada 6h (VO/SNG). Bloqueia síntese E conversão periférica. Metimazol se PTU indisponível (NÃO bloqueia conversão periférica)",
            color: "#EF4444",
          },
          {
            text: "3. IODO INORGÂNICO: Após ≥ 1h do antitireoidiano → Lugol 5 gotas 6/6h ou SSKI. Bloqueia liberação de HT pré-formados (efeito de Wolff-Chaikoff). NUNCA antes do antitireoidiano!",
            color: "#F97316",
          },
          {
            text: "4. GLICOCORTICOIDE: Hidrocortisona 100 mg IV 8/8h. ↓ conversão T4→T3 + previne insuficiência adrenal relativa",
            color: "#F59E0B",
          },
          {
            text: "5. SUPORTE: Resfriamento físico (NÃO salicilatos), paracetamol para febre, hidratação, correção eletrolítica, O₂, UTI",
            color: "#10B981",
          },
          {
            text: "6. IDENTIFICAR E TRATAR O FATOR PRECIPITANTE (antibiótico se infecção, mesmo sem febre proeminente)",
            color: "#6366F1",
          },
        ],
      },
  ...
  hipotireoidismo: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          {
            label: "Fadiga, sonolência, bradipsiquia",
            value:
              "Déficit cognitivo, memória prejudicada, depressão, loucura mixedematosa (psicose em hipotireoidismo grave).",
            highlight: false,
          },
          {
            label: "Intolerância ao frio",
            value: "Redução do metabolismo basal e termogênese.",
            highlight: false,
          },
          {
            label: "Bradicardia",
            value:
              "Diminuição da frequência cardíaca e do débito cardíaco. Derrame pericárdico em hipotireoidismo grave.",
            highlight: true,
          },
          {
            label: "Obstipação intestinal",
            value: "Redução da motilidade GI.",
            highlight: false,
          },
          {
            label: "Pele seca, edema periorbital",
            value:
              "Mucopolissacarídeos acumulam → mixedema (edema não cacifo). Face puffy.",
            highlight: true,
          },
          {
            label: "Hiperprolactinemia",
            value:
              "TRH elevado estimula prolactina → galactorreia, irregularidade menstrual, disfunção erétil. Diagnóstico diferencial com prolactinoma.",
            highlight: true,
          },
          {
            label: "Dislipidemia",
            value:
              "↑LDL-colesterol (↓receptores hepáticos de LDL). Risco cardiovascular aumentado.",
            highlight: false,
          },
          {
            label: "Reflexo aquileu lentificado",
            value:
              "Sinal clássico de hipotireoidismo — fase de relaxamento prolongada.",
            highlight: true,
          },
        ],
      },
      ...
      },
      {
        ...
        items: [
          {
            label: "Dose adultos jovens",
            value:
              "1,6–1,8 µg/kg/dia. Mulheres: 75–100 µg/dia. Homens: 100–150 µg/dia.",
            highlight: false,
          },
          {
            label: "Início no idoso / cardiopata",
            value:
              "Dose baixa: 12,5–25 µg/dia → ajuste gradual de 12,5–25 µg a cada 6 semanas.",
            highlight: true,
          },
          {
            label: "Administração",
            value:
              "JEJUM, 30–60 min antes do café OU ao deitar (estômago vazio). Absorção reduzida com cálcio, ferro, antiácidos, IBP.",
            highlight: true,
          },
          {
            label: "Monitoramento",
            value:
              "Reavaliar TSH após 6 semanas do início/ajuste. Meta: TSH 1,0–2,5 mUI/L (jovens); 4–6 mUI/L (idosos > 70 anos).",
            highlight: true,
          },
          {
            label: "Hipo central",
            value:
              "Monitorar com T4L (TSH inapropriado — não usar TSH como guia).",
            highlight: true,
          },
          {
            label: "Gestação",
            value:
              "Aumentar dose 25–30% assim que gestação confirmada. Meta: TSH < 2,5 mUI/L (1º tri) / < 3,0 mUI/L (2º–3º tri).",
            highlight: false,
          },
        ],
      },
      ...
      },
      {
        ...
        steps: [
          {
            text: "Suspeita: paciente hipotireoidiano + rebaixamento de consciência + hipotermia + instabilidade hemodinâmica",
            color: "#0EA5E9",
          },
          {
            text: "Diagnóstico CLÍNICO — não aguardar resultados para iniciar tratamento",
            color: "#0EA5E9",
          },
          {
            text: "PRIMEIRO: Glicocorticoide (hidrocortisona 100 mg IV 8/8h) → previne crise adrenal ao repor HT",
            color: "#EF4444",
          },
          {
            text: "Levotiroxina IV (T4): 200–500 µg ataque → 50–100 µg/dia manutenção ± Liotironina (T3) IV em casos selecionados",
            color: "#F59E0B",
          },
          {
            text: "Suporte UTI: aquecimento PASSIVO gradual, via aérea, ventilação, correção de hiponatremia e hipoglicemia",
            color: "#10B981",
          },
          {
            text: "Identificar e tratar fator precipitante (infecção = mais comum)",
            color: "#F97316",
          },
        ],
      },
        ...
        items: [
          {
            ...
            value:
              "Especialmente se nódulo pré-existente. Suspeita alta de malignidade ou tireoidite aguda.",
            highlight: true,
          },
          {
            label: "Consistência endurecida / pétrea",
            value:
              "Sugere infiltração tumoral. Nódulo colide é mole; neoplasia é dura.",
            highlight: true,
          },
          {
            label: "Fixação a planos profundos",
            value: "Invasão local — sinal de malignidade avançada.",
            highlight: true,
          },
          {
            label: "Disfonia / rouquidão",
            value:
              "Paralisia do nervo laríngeo recorrente por invasão tumoral.",
            highlight: true,
          },
          {
            label: "Linfonodomegalia cervical",
            value:
              "Metástase linfonodal regional → aumenta fortemente suspeita de Ca papilífero.",
            highlight: true,
          },
          {
            label: "HF de Ca de tireoide / MEN 2",
            value:
              "Especialmente para carcinoma medular (mutação RET). Rastrear calcitonina.",
            highlight: false,
          },
          {
            label: "Irradiação cervical prévia",
            value: "Fator de risco bem estabelecido para carcinoma papilífero.",
            highlight: false,
          },
        ],
      },
        ...
        grades: [
          {
            ...
            items: [
              ...
              "Se insatisfatório: cirurgia (alto risco) ou US-follow (baixo risco)",
            ],
          },
          {
            grade: "II",
            ...
            items: [
              "Benigno",
              "Seguimento com US (anual → intervalos maiores)",
              "Malignidade < 3%",
            ],
          },
          {
            ...
            color: "#F59E0B",
            items: [
              "AUS / FLUS (indeterminado)",
              "Repetir PAAF; considerar cirurgia ou teste molecular",
              "Malignidade 5–15%",
            ],
          },
          {
            ...
            color: "#F97316",
            items: [
              "Neoplasia folicular / suspeita (FN/SFN)",
              "Lobectomia recomendada",
              "Testes moleculares podem ajudar",
              "Malignidade 15–30%",
            ],
          },
          {
          ...
          },
          {
            ...
            items: [
              "Maligno",
              "Tireoidectomia total + ablação com iodo radioativo",
              "Malignidade 97–99%",
            ],
          },
        ],
    ...
    blocks: [
      {
        ...
        color: "#6366F1",
        title:
          "4 Tipos Histológicos — Prognóstico Inversamente Proporcional à Diferenciação",
      ...
      },
      {
        ...
        items: [
          {
            label: "Medular — Células C / Calcitonina",
            value:
              "Esporádico (80%) ou hereditário (20% = MEN 2A, MEN 2B, Ca medular familiar). Proto-oncogene RET. Diarreia + flushing em doença avançada. Diagnóstico: calcitonina sérica elevada. TTO: tireoidectomia total + esvaziamento cervical central. SEM iodo radioativo, SEM supressão TSH. Seguimento: calcitonina + CEA.",
            highlight: true,
          },
          {
            label: "MEN 2A",
            value:
              "Ca medular + feocromocitoma + hiperparatireoidismo primário. Mutação RET (codons 634, 609, 618, 620).",
            highlight: false,
          },
          {
            label: "MEN 2B",
            value:
              "Ca medular + feocromocitoma + neuromas mucosos + hábito marfanoide. Mutação RET (codon 918). Mais agressivo.",
            highlight: false,
          },
          {
            label: "Anaplásico",
            value:
              "Idosos. Crescimento ultrarrápido. Tríade: massa cervical volumosa + disfonia + disfagia. p53 mutado. Mutação BRAF V600E em alguns → alvo terapêutico. Sempre estágio IV. SEM iodo radioativo. Prognóstico: meses.",
            highlight: true,
          },
        ],
      },
      {
        ...
        steps: [
          {
            text: "Tireoidectomia total → estadiar risco de recorrência (ATA 2025: baixo, intermediário, alto)",
            color: "#6366F1",
          },
          {
            text: "Ablação com iodo radioativo (RAI): indicada em risco intermediário/alto, metástases, invasão extratiroidiana",
            color: "#EF4444",
          },
          {
            text: "Supressão de TSH com levotiroxina: alto risco → TSH < 0,1; baixo risco → TSH 0,5–2,0",
            color: "#F59E0B",
          },
          {
            text: "Dosagem de Tireoglobulina (Tg) + anti-Tg: 6–12 semanas pós-cirurgia e periodicamente",
            color: "#10B981",
          },
          {
            text: "US cervical: 6–12 meses após cirurgia nos primeiros 2 anos",
            color: "#0EA5E9",
          },
          {
            text: "Resposta excelente = Tg indetectável + US negativa + sem doença estrutural → reduzir intensidade de seguimento",
            color: "#84CC16",
          },
        ],
      },
